...
local sculptable_materials =
{
	...
	goldnugget  = {swapfile="gold_nugget",	symbol="gold_nugget",	material = "gold"},
	moonrocknugget  = {swapfile="moonrock_nugget",	symbol="moonrock_nugget",	material = "moonrock"},
	thulecite_pieces  = {swapfile="thulecite_pieces",	symbol="thulecite_pieces",	material = "thulecite"},
}
